...
describe('c-lwc-exam-creation', () => {
    ...
    it('Test all of the default values for variables in the js file', () => {
        ...
        expect(element.nameField).toStrictEqual({"fieldApiName": "Name", "objectApiName": "Exam__C"});
        expect(element.nextExamField).toStrictEqual({"fieldApiName": "Next_Exam__c", "objectApiName": "Exam__C"});
        expect(element.titanField).toStrictEqual({"fieldApiName": "Titan__c", "objectApiName": "Exam__C"});
        expect(element.dPGField).toStrictEqual({"fieldApiName": "Default_Passing_Grade__c", "objectApiName": "Exam__C"});
        expect(element.dTLField).toStrictEqual({"fieldApiName": "Default_Time_Limit__c", "objectApiName": "Exam__C"});
    ...
    it('Test Name lightning-input onchange', () => {
        ...
        const inputName = Array.from(element.shadowRoot.querySelectorAll("lightning-input"))[0];
    ...
    it('Test Titan lightning-input onchange', () => {
        ...
        // make sure the correct lightning input is being selected to test on
        const inputTitan = Array.from(element.shadowRoot.querySelectorAll("lightning-input"))[1];
    ...
    it('Test Next Exam lightning-input onchange', () => {
        ...
        // make sure the correct lightning input is being selected to test on
        const inputNextExam = Array.from(element.shadowRoot.querySelectorAll("lightning-input"))[2];
    ...
    it('Test Default Passing Grade lightning-input onchange', () => {
        ...
        // make sure the correct lightning input is being selected to test on
        const inputDPG = Array.from(element.shadowRoot.querySelectorAll("lightning-input"))[3];
    ...
    it('Test Default Time Limit lightning-input onchange', () => {
        ...
        // make sure the correct lightning input is being selected to test on
        const inputDTL = Array.from(element.shadowRoot.querySelectorAll("lightning-input"))[4];
