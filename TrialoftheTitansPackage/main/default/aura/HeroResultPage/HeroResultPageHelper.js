...
({
                            ...
                            [
                                "aura:html",
                                {
                                    ...
                                    HTMLAttributes: {
                                        ...
                                        "aura:id": "exam-btn",
                                        class: `exam-btn ${singleExam.Exam__r.Titan__r.Name.replace(
                                            " ",
                                            "_"
                                        ).toLowerCase()}`
                                    }
    ...
    markActiveTab: function (cmp, event) {
        ...
        document.querySelectorAll(".titan-tab").forEach((singleTab) => {
            ...
            singleTab.style.borderLeft = cmp.get("v.currentPage") === slug ? "3px solid black" : "";
            singleTab.style.boxShadow = cmp.get("v.currentPage") === slug ? "3px 3px 2px black" : "";
        });
    },
