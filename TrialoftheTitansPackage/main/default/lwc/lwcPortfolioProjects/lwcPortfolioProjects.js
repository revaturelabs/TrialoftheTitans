...
export default class LwcPortfolioProjects extends LightningElement {
  ...
  /*Don't think these getters are necessary for how this component currently works, 
  ...
  updateProject() {
    const fields = {};
    fields[PROJECTID_FIELD.fieldApiName] =
      this.template.querySelector("[data-field='Id']").value;
    //fields[NAME_FIELD.fieldApiName] = this.template.querySelector("[data-field='Name']").value;
    fields[DESCRIPTION_FIELD.fieldApiName] = this.template.querySelector(
      "[data-field='Description']"
    ).value;
    fields[ROLES_FIELD.fieldApiName] = this.template.querySelector(
      "[data-field='Roles']"
    ).value;
    fields[TECH_FIELD.fieldApiName] = this.template.querySelector(
