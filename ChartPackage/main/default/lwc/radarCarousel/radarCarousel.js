...
const ICON_PATH = '/_slds/icons/utility-sprite/svg/symbols.svg'
const PAUSE_ICON = 'pause'
const PLAY_ICON = 'play'
const PAUSE_STRING = 'Stop auto-scroll'
const PLAY_STRING = 'Start auto-scroll'
...
export default class RadarCarousel extends LightningElement {
    ...
    get svgHref() {
        return `${ICON_PATH}#${this.autoScrollIcon}`
    }
    ...
    autoScrollOn() {
        ...
        if (!this.disableAutoScroll) {
            ...
            this.togglePlayString = PAUSE_STRING
    ...
    autoScrollOff() {
        if (!this.disableAutoScroll) {
            ...
            this.togglePlayString = PLAY_STRING
