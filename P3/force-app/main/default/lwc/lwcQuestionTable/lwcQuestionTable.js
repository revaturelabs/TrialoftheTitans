...
export default class QuestionTableLWC extends LightningElement {
  ...
  addQuestion2Pool() {
    ...
    /*
     * Edited by Wayne He (10/25/2021)
     * Previous Code: if(selectedObjectPools.length <= 0 || this.selectedRows <= 0 || selectedObjectPools == null)
     * Reason: Null checker should be first before checking for properties.
     */
    if (
      selectedObjectPools == null ||
      ...
      if (this.enableToast) {
        const event = new ShowToastEvent({
          ...
          message:
            "Please select at least a question and a pool to add the question to the pool."
        });
